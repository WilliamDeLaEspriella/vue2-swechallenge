  ...
  <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
    ...
    <div class="relative px-4">
      ...
      <div class="flex items-center w-full my-6 -ml-1.5">
        ...
        <div class="w-11/12">
          <p class="text-sm">
            New rating added for <a href="#" class="text-blue-600 font-bold">$AAPL</a>.
          </p>
      ...
      <div class="flex items-center w-full my-6 -ml-1.5">
        ...
        <div class="w-11/12">
          <p class="text-sm">
            User viewed details for <a href="#" class="text-blue-600 font-bold">$TSLA</a>.
          </p>
      ...
      <div class="flex items-center w-full my-6 -ml-1.5">
        ...
        <div class="w-11/12">
          <p class="text-sm">
            Target price updated for <a href="#" class="text-blue-600 font-bold">$AMZN</a> from
            $3,200 to $3,500.
          </p>
      ...
      <div class="flex items-center w-full my-6 -ml-1.5">
        ...
        <div class="w-11/12">
          <p class="text-sm">
            <a href="#" class="text-blue-600 font-bold">Cecilia Hendric</a> issued a new
            recommendation for $NFLX.
          </p>
